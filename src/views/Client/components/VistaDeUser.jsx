                    ...
                    <div className="col">
                        <div className="container overflow-hidden">
                            <div className="row gx-5">
                                <div className="col">
                                    <div className=" p-3" >
                                        <h2 className="mt-4">Cuenta de Usuario</h2>
                                        <hr />
                                        <div className="user-details mt-4">
                                            <p className="text-start"><strong>User:</strong> </p>
                                            <p className="text-start"><strong>Correo Electrónico:</strong> </p>
                                            <p className="text-start"><strong>Tipo de Cuenta:</strong> </p>
                                        </div>
                                    </div>
                                </div>
